...
public class GestionParking {
    ...
    public void registrarVehiculo() {
        ...
        do {
            ...
            switch (opcionSeleccionada) {
                case "1":
                    preguntarDatosCoche(listaVehiculos);
                    break;
                case "2":
                    preguntarDatosMoto(listaVehiculos);
                    break;
                case "3":
                    preguntarDatosBici(listaVehiculos);
                    break;
                case "4":
    ...
    public void preguntarDatosCoche(ArrayList<Vehiculo> listaVehiculos) {
    ...
    public void preguntarDatosMoto(ArrayList<Vehiculo> listaVehiculos) {
    ...
    public void preguntarDatosBici(ArrayList<Vehiculo> listaVehiculos) {
        Scanner scanner = new Scanner(System.in);
